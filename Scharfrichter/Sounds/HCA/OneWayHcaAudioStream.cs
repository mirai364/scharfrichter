...
namespace Scharfrichter.Codec.Sounds.HCA
{
    public sealed class OneWayHcaAudioStream : HcaAudioStreamBase
    {
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            bool outputWaveHeader = OutputWaveHeader;
            OneWayHcaDecoder decoder = _decoder as OneWayHcaDecoder;
            if (decoder == null)
            {
            ...
            {
                int maxToCopy;
                HcaAudioStreamDecodeState state = _state;
                switch (state)
                {
                    ...
                    case HcaAudioStreamDecodeState.WaveHeaderTransmitted:
                        {
                            ...
                            uint decodedBlockCount = decoder.DecodeBlocks(_waveDataBuffer);
        ...
        protected override bool HasMoreData
        {
            get
            {
                ...
                {
                    OneWayHcaDecoder decoder = _decoder as OneWayHcaDecoder;
                    bool hasMore = decoder?.HasMore ?? false;
